...
const EditProfile = ({
  ...
  const uploadImage = async e => {
    ...
    const res = await fetch(
      "https://api.cloudinary.com/v1_1/dhgakic89/image/upload",
      {
        method: "POST",
        body: data
      }
  ...
  }, [loading, getCurrentProfile, loadingImg]); //just when is load i want this to run
